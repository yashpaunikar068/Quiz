let questions = [
  {
      "n" :"What is the full form of Ajax?",
  ...
  {
      "n" :"What is the name of the object used for AJAX request?",
      "a":"HttpRequest",
      "b":"xmlRequest",
      "c":"XMLHTTPRequest",
      "d":"Request",
  ...
  {
      "n" :"Implementing AJAX in our websites we can make our web pages ____ ?",
      "a":"More Dynamic",
  ...
  {
      "n" :"AJAX allows web page to dynamically",
      "a":"Change content",
      "b":"Reload at times",
   ...
   {
      "n" :"___ Of the following technologies, which one provides the ability to dynamically interact with Web page layout?",
      "a":"XML",
      "b":"HTML",
      "c":"JavaScript",
  ...
  {
      "n" :"What does the XMLHttpRequest object accomplish in Ajax?",
  ...
  {
      "n" :" What two main structures compose JSON?",
      "a":"Key and value",
      "b":"Class and Object",
  ...
  {
      "n" :"Which is the correct format of writing a json name/value pair?",
      "a":"name : value'",
      "b":"name = \"value\"",
      "c":"\"name\" : \"value\"",
      "d":"All of the Above",
